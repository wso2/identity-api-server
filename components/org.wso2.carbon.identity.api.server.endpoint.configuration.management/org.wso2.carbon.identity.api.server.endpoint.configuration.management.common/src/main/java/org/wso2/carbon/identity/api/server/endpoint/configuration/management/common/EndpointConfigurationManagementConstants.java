...
public class EndpointConfigurationManagementConstants {
    ...
    public enum ErrorMessage {
        ...
        // Client errors 600xx.
        ERROR_CODE_ENDPOINT_URI_NOT_SPECIFIED("60001", "Empty endpoint URI", "Endpoint URI is " +
                "not specified in the request"),
        ERROR_CODE_REFERENCE_NAME_NOT_SPECIFIED("60002", "Empty reference name",
                "Endpoint reference name is not specified in the request"),
        ERROR_CODE_AUTH_TYPE_URI_NOT_SPECIFIED("60003", "Empty auth type", "Auth type is " +
                "not specified in the request"),
        ERROR_CODE_CONFLICT_CONFIGURATION("60004", "Configuration already exists.",
