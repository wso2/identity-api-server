...
public class OperationRecordsResponse  {
    ...
    private List<OperationRecord> operationRecords = null;
    ...
    **/
    ...
    public OperationRecordsResponse addLinksItem(Link linksItem) {
        if (this.links == null) {
        ...
        /**
    **/
    public OperationRecordsResponse operationRecords(List<OperationRecord> operationRecords) {
    ...
    public OperationRecordsResponse addOperationRecordsItem(OperationRecord operationRecordsItem) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        OperationRecordsResponse operationRecordsResponse = (OperationRecordsResponse) o;
        return Objects.equals(this.links, operationRecordsResponse.links) &&
            Objects.equals(this.operationRecords, operationRecordsResponse.operationRecords);
    }

    @Override
    public int hashCode() {
        return Objects.hash(links, operationRecords);
    }
    ...
    public String toString() {
        ...
        sb.append("class OperationRecordsResponse {\n");
