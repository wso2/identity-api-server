...
package org.wso2.carbon.identity.api.server.user.credential.management.v1.factories;
...
import org.wso2.carbon.identity.api.server.user.credential.management.common.core.PasskeyCredentialHandler;
import org.wso2.carbon.identity.api.server.user.credential.management.common.core.PushCredentialHandler;
...
/**
 * Factory class for UserCredentialManagementServiceImpl.
 */
public class UserCredentialManagementServiceFactory {

    public static UserCredentialManagementServiceImpl getUserCredentialManagementService() {
        ...
        return new UserCredentialManagementServiceImpl(handlerMap);
    }
}
