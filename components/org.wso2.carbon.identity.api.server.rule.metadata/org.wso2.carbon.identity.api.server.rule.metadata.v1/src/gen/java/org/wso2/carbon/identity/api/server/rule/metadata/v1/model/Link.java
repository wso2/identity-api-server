...
public enum RelEnum {
    ...
    **/
    ...
    /**
    * Indicates the endpoint’s relation to retrieving or filtering field values.
    **/
    ...
    @ApiModelProperty(value = "Indicates the endpoint’s relation to retrieving or filtering field values.")
    @JsonProperty("rel")
    @Valid
