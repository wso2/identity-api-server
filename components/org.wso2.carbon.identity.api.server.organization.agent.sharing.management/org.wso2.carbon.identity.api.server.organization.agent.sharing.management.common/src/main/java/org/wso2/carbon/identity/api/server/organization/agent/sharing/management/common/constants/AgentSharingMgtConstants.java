...
public class AgentSharingMgtConstants {
    ...
    public enum ErrorMessage {
        ...
        ERROR_EMPTY_AGENT_IDS("60013",
                "Empty agentIds list in agent criteria.",
                "The agentIds list in the agent criteria must contain at least one entry."),
