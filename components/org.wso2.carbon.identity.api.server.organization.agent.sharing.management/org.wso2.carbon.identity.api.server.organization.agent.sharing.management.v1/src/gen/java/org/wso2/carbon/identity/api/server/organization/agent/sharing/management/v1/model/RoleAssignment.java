...
/**
 * Role assignment configuration for shared agents.  This controls which roles are assigned to the agent in the target organization.  - &#x60;NONE&#x60;     → Do not assign any roles via agent sharing. - &#x60;SELECTED&#x60; → Assign only the roles listed under &#x60;roles&#x60;.
 **/
...
@ApiModel(description = "Role assignment configuration for shared agents.  This controls which roles are assigned to the agent in the target organization.  - `NONE`     → Do not assign any roles via agent sharing. - `SELECTED` → Assign only the roles listed under `roles`.")
