...
public class AgentOrgShareConfig  {
    ...
    /**
    * Organization ID to share the agents with.
    **/
    public AgentOrgShareConfig orgId(String orgId) {

        this.orgId = orgId;
        return this;
    }
    
    @ApiModelProperty(required = true, value = "Organization ID to share the agents with.")
    @JsonProperty("orgId")
    @Valid
    ...
    **/
    public AgentOrgShareConfig policy(String policy) {
    ...
    /**
    **/
    public AgentOrgShareConfig roleAssignment(RoleAssignment roleAssignment) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AgentOrgShareConfig agentOrgShareConfig = (AgentOrgShareConfig) o;
        return Objects.equals(this.orgId, agentOrgShareConfig.orgId) &&
            Objects.equals(this.policy, agentOrgShareConfig.policy) &&
            Objects.equals(this.roleAssignment, agentOrgShareConfig.roleAssignment);
    }
    ...
    public String toString() {
        ...
        sb.append("class AgentOrgShareConfig {\n");
