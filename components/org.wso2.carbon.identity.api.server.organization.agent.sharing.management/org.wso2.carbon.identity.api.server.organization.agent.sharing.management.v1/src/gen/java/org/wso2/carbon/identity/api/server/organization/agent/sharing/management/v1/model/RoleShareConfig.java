...
/**
 * Role to be assigned to the shared agent in the sub-organization.
 **/
...
@ApiModel(description = "Role to be assigned to the shared agent in the sub-organization.")
public class RoleShareConfig  {
    ...
    **/
    ...
    @ApiModelProperty(example = "Org Admin", required = true, value = "Human-readable name of the role.")
