...
/**
 * Response showing the roles assigned to a agent within a specific organization, with pagination support for large role sets. 
 **/
...
@ApiModel(description = "Response showing the roles assigned to a agent within a specific organization, with pagination support for large role sets. ")
public class AgentSharedRolesResponse  {
    ...
    **/
    public AgentSharedRolesResponse links(List<AgentSharedOrganizationsResponseLinks> links) {
    ...
    public AgentSharedRolesResponse addLinksItem(AgentSharedOrganizationsResponseLinks linksItem) {
        if (this.links == null) {
    ...
    **/
    public AgentSharedRolesResponse roles(List<RoleWithAudience> roles) {
    ...
    public AgentSharedRolesResponse addRolesItem(RoleWithAudience rolesItem) {
        if (this.roles == null) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AgentSharedRolesResponse agentSharedRolesResponse = (AgentSharedRolesResponse) o;
        return Objects.equals(this.links, agentSharedRolesResponse.links) &&
            Objects.equals(this.roles, agentSharedRolesResponse.roles);
    }
    ...
    public String toString() {
        ...
        sb.append("class AgentSharedRolesResponse {\n");
