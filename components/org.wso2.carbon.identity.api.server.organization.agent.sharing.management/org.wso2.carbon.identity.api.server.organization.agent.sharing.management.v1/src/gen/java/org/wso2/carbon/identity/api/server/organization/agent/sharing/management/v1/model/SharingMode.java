...
/**
 * Represents whether an agent is shared using a future-sharing policy. The policy is always a future policy, and the associated role assignments are mapped accordingly.
 **/
...
@ApiModel(description = "Represents whether an agent is shared using a future-sharing policy. The policy is always a future policy, and the associated role assignments are mapped accordingly.")
