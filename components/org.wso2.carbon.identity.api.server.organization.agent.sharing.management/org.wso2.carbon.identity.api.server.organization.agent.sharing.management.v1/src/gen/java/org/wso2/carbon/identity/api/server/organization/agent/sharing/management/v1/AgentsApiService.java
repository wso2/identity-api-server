...
import org.wso2.carbon.identity.api.server.organization.agent.sharing.management.v1.*;
import org.wso2.carbon.identity.api.server.organization.agent.sharing.management.v1.model.*;
...
public interface AgentsApiService {
      ...
      public Response agentsAgentIdSharedOrganizationsGet(String agentId, String after, String before, Integer limit, String filter, Boolean recursive);

      public Response agentsAgentIdSharedRolesGet(String agentId, String orgId, String after, String before, Integer limit, String filter, Boolean recursive);
