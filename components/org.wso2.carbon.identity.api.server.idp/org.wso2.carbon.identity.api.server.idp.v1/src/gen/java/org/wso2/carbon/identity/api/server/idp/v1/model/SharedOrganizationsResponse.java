...
public class SharedOrganizationsResponse  {
    ...
    **/
    ...
    @ApiModelProperty(example = "[{\"href\":\"/api/server/v1/identity-providers/67f5a202-48c4-4313-9327-016da5f08f17/share?limit=10&recursive=false&next=MTA=\",\"rel\":\"next\"},{\"href\":\"/api/server/v1/identity-providers/67f5a202-48c4-4313-9327-016da5f08f17/share?limit=10&recursive=false&before=MTA=\",\"rel\":\"previous\"}]", value = "")
    @JsonProperty("links")
    @Valid
