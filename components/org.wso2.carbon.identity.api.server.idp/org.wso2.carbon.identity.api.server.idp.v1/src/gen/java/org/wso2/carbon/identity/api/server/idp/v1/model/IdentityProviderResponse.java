...
public class IdentityProviderResponse  {
    ...
    **/
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, description, isEnabled, isPrimary, image, isFederationHub, homeRealmIdentifier, certificate, alias, idpIssuerName, claims, roles, federatedAuthenticators, provisioning);
    }
