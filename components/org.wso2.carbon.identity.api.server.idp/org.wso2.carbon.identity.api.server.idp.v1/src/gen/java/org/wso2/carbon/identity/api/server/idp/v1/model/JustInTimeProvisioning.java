...
public enum IdpGroupSyncMethodEnum {
    ...
    @XmlEnumValue("OVERRIDE_ALL") OVERRIDE_ALL(String.valueOf("OVERRIDE_ALL")), @XmlEnumValue("PRESERVE_EXISTING") PRESERVE_EXISTING(String.valueOf("PRESERVE_EXISTING"));
    ...
    private IdpGroupSyncMethodEnum idpGroupSyncMethod = IdpGroupSyncMethodEnum.PRESERVE_EXISTING;
