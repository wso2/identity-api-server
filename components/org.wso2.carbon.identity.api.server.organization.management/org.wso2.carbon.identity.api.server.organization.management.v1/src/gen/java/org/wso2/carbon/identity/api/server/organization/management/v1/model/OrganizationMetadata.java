...
public enum TypeEnum {
    ...
    **/
    ...
    /**
    **/
    public OrganizationMetadata organizationHandle(String organizationHandle) {
    ...
    **/
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.id, organizationMetadata.id) &&
            ...
            Objects.equals(this.organizationHandle, organizationMetadata.organizationHandle) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, organizationHandle, description, status, created, lastModified, type, parent, attributes, permissions, discoveryAttributes);
    }
