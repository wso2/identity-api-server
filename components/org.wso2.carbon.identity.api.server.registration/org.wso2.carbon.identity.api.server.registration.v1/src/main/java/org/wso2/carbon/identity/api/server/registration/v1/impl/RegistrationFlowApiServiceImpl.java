...
package org.wso2.carbon.identity.api.server.registration.v1.impl;

import org.wso2.carbon.identity.api.server.registration.v1.RegistrationFlowApiService;
...
import org.wso2.carbon.identity.api.server.registration.v1.factories.ServerRegistrationFlowMgtServiceFactory;
...
public class RegistrationFlowApiServiceImpl implements RegistrationFlowApiService {
    ...
    public Response updateRegistrationFlow(RegistrationFlowRequest registrationFlowRequest) {
        ...
        return Response.ok().entity(registrationFlowMgtService.updateRegistrationFlow(registrationFlowRequest)).build();
    }
}
