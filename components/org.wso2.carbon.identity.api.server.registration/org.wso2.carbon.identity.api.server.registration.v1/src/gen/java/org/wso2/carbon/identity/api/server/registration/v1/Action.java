...
/**
 * Represent an action which controls the registration flow
 **/
...
public enum TypeEnum {
    ...
    @XmlEnumValue("NEXT") NEXT(String.valueOf("NEXT")), @XmlEnumValue("EXECUTOR") EXECUTOR(String.valueOf("EXECUTOR"));
