...
/**
 * Represent a single step in the registration flow process
 **/
...
public class Step  {
    ...
    **/
    ...
    /**
    **/
    public Step blocks(List<Block> blocks) {
    ...
    public Step addBlocksItem(Block blocksItem) {
        if (this.blocks == null) {
    ...
    **/
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.id, step.id) &&
            ...
            Objects.equals(this.blocks, step.blocks) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, type, blocks, action, size, position);
    }
