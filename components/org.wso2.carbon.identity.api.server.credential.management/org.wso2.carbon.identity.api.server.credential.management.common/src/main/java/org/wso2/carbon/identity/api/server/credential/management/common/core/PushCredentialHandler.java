...
import static org.wso2.carbon.identity.api.server.credential.management.common.CredentialManagementConstants.ErrorMessages;
...
public class PushCredentialHandler implements CredentialHandler {
    ...
    public void deleteCredential(CredentialDeletionRequestDTO credentialDeletionRequest)
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("Deleting push authentication credential for entity ID: "
        ...
        try {
            ...
            throw CredentialManagementUtils.handleClientException(CredentialManagementConstants.ErrorMessages
                    .ERROR_CODE_DELETE_PUSH_AUTH_CREDENTIAL, e, credentialDeletionRequest.getCredentialId());
        } catch (PushDeviceHandlerException e) {
            throw CredentialManagementUtils.handleServerException(
                    CredentialManagementConstants.ErrorMessages.ERROR_CODE_DELETE_PUSH_AUTH_DEVICE, e,
                    credentialDeletionRequest.getEntityId());
        }
    }
