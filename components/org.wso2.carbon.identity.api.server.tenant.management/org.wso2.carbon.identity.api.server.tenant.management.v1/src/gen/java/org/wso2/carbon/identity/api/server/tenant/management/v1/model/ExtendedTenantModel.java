...
public class ExtendedTenantModel  {
    ...
    **/
    public ExtendedTenantModel domain(String domain) {
    ...
    * Tenant domain of the tenant.
    **/
    public ExtendedTenantModel code(String code) {
    ...
    **/
    public ExtendedTenantModel purpose(String purpose) {
    ...
    /**
    **/
    public ExtendedTenantModel owners(List<Owner> owners) {
    ...
    public ExtendedTenantModel addOwnersItem(Owner ownersItem) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ExtendedTenantModel extendedTenantModel = (ExtendedTenantModel) o;
        return Objects.equals(this.domain, extendedTenantModel.domain) &&
            Objects.equals(this.code, extendedTenantModel.code) &&
            Objects.equals(this.purpose, extendedTenantModel.purpose) &&
            Objects.equals(this.owners, extendedTenantModel.owners);
    }
    ...
    public String toString() {
        ...
        sb.append("class ExtendedTenantModel {\n");
