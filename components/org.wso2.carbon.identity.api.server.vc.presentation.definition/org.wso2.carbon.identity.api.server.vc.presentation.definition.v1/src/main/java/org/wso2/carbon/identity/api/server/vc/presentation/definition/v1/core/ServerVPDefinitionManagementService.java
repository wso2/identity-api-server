...
package org.wso2.carbon.identity.api.server.vc.presentation.definition.v1.core;

import com.fasterxml.jackson.databind.ObjectMapper;
import org.wso2.carbon.identity.api.server.common.ContextLoader;
import org.wso2.carbon.identity.api.server.vc.presentation.definition.common.VPDefinitionManagementConstants.ErrorMessage;
import org.wso2.carbon.identity.api.server.vc.presentation.definition.common.VPDefinitionManagementServiceHolder;
import org.wso2.carbon.identity.api.server.vc.presentation.definition.v1.Error;
import org.wso2.carbon.identity.api.server.vc.presentation.definition.v1.PresentationDefinitionCreationModel;
import org.wso2.carbon.identity.api.server.vc.presentation.definition.v1.PresentationDefinitionList;
import org.wso2.carbon.identity.api.server.vc.presentation.definition.v1.PresentationDefinitionListItem;
import org.wso2.carbon.identity.api.server.vc.presentation.definition.v1.PresentationDefinitionResponse;
import org.wso2.carbon.identity.api.server.vc.presentation.definition.v1.PresentationDefinitionUpdateModel;
...
public class ServerVPDefinitionManagementService {
    ...
    public PresentationDefinitionResponse createPresentationDefinition(
        ...
        try {
            ...
            String definitionJson = serializeDefinition(creationModel.getDefinition());
    ...
    public PresentationDefinitionResponse updatePresentationDefinition(
        ...
        try {
            ...
            String definitionJson = updateModel.getDefinition() != null
                    ? serializeDefinition(updateModel.getDefinition()) : null;
