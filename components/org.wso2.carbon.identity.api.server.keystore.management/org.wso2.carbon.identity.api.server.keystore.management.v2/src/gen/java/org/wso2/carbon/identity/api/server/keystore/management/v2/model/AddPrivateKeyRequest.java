...
public class AddPrivateKeyRequest  {
    ...
    **/
    ...
    /**
    * The chain of the certificate that starts with server&#39;s certificate.
    **/
    public AddPrivateKeyRequest certificateChain(String certificateChain) {

        this.certificateChain = certificateChain;
        return this;
    }
    
    @ApiModelProperty(example = "-----BEGIN CERTIFICATE----- ---- -----END CERTIFICATE----- -----BEGIN CERTIFICATE----- -----END CERTIFICATE-----", value = "The chain of the certificate that starts with server's certificate.")
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.alias, addPrivateKeyRequest.alias) &&
            Objects.equals(this.privateKey, addPrivateKeyRequest.privateKey) &&
            Objects.equals(this.certificateChain, addPrivateKeyRequest.certificateChain);
    }

    @Override
    public int hashCode() {
        return Objects.hash(alias, privateKey, certificateChain);
    }
