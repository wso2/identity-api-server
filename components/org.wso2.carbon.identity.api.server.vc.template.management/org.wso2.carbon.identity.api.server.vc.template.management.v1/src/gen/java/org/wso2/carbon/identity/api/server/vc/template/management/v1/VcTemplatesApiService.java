...
import org.wso2.carbon.identity.api.server.vc.template.management.v1.*;
import org.wso2.carbon.identity.api.server.vc.template.management.v1.*;
...
public interface VcTemplatesApiService {
      ...
      public Response updateVCTemplate(String templateId, VCTemplateUpdateModel vcTemplateUpdateModel);
}
