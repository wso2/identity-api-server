...
/**
 * A single PATCH operation (SCIM-like) for user sharing.  Currently supported: - &#x60;op: \&quot;add\&quot;&#x60;    → Add roles. - &#x60;op: \&quot;remove\&quot;&#x60; → Remove roles.
 **/
...
@ApiModel(description = "A single PATCH operation (SCIM-like) for user sharing.  Currently supported: - `op: \"add\"`    → Add roles. - `op: \"remove\"` → Remove roles.")
