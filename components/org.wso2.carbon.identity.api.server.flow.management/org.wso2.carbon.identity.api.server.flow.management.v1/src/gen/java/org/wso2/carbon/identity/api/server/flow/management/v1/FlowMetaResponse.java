...
public class FlowMetaResponse  {
    ...
    **/
    ...
    public FlowMetaResponse addSupportedExecutorsItem(String supportedExecutorsItem) {
        ...
        /**
    * Metadata for the executors contributed by deployed extensions. Built in executors appear by name in supportedExecutors only.
    **/
    ...
    @ApiModelProperty(value = "Metadata for the executors contributed by deployed extensions. Built in executors appear by name in supportedExecutors only.")
