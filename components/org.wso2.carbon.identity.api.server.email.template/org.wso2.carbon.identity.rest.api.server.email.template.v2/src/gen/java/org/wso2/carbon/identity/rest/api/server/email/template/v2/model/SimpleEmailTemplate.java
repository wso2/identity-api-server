...
public class SimpleEmailTemplate  {
    ...
    **/
    ...
    @ApiModelProperty(example = "/t/{tenant-domain}/api/server/v2/email/template-types/YWNjb3VudGNvbmZpcm1hdGlvbg/templates/en_US", required = true, value = "Location of the created/updated resource.")
    @JsonProperty("self")
    @Valid
