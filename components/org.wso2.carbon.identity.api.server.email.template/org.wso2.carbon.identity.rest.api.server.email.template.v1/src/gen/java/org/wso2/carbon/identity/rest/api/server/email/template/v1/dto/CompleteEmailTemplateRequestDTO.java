...
public class CompleteEmailTemplateRequestDTO {

    @Valid 
    @NotNull(message = "Property localeCode cannot be null.") 
    ...
    **/
    @ApiModelProperty(required = true, value = "Locale code in which the template should be added. This locale should be a one supported by Java.util.Locale class.")
    ...
    **/
    ...
    public String toString() {
        ...
        sb.append("class CompleteEmailTemplateRequestDTO {\n");
