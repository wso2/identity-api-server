...
import org.wso2.carbon.identity.rest.api.server.email.template.v1.impl.EmailTemplatesApiServiceImpl;

public class EmailApiServiceFactory {

   private final static EmailApiService service = new EmailTemplatesApiServiceImpl();
