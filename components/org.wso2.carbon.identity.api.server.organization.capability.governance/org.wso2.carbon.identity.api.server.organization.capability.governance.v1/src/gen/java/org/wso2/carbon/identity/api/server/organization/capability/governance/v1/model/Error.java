...
public class Error  {
    ...
    **/
    ...
    @ApiModelProperty(example = "OCGM-60001", required = true, value = "")
    @JsonProperty("code")
    @Valid
    ...
    **/
    ...
    @ApiModelProperty(example = "Short error message.", required = true, value = "")
    ...
    **/
    ...
    @ApiModelProperty(example = "Detailed description with context.", value = "")
