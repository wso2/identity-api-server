...
public class IdentityGovernanceApiServiceImpl implements IdentityGovernanceApiService {
    ...
    @Override
    public Response revertAllConnectorProperties(String categoryId, String connectorId) {

        identityGovernanceService.revertAllGovernanceConnectorProperties(categoryId, connectorId);
