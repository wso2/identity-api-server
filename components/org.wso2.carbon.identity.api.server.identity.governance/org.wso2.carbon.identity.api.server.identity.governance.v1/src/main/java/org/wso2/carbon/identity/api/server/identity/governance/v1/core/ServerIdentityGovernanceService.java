...
public class ServerIdentityGovernanceService {
    ...
    /**
     * Revert all governance connector properties.
     *
     * @param categoryId  Governance connector category id.
     * @param connectorId Governance connector id.
     */
    public void revertAllGovernanceConnectorProperties(String categoryId, String connectorId) {
        ...
        try {
            ...
            for (PropertyRes property : connector.getProperties()) {
                properties.add(property.getName());
            }

            identityGovernanceService.deleteConfiguration(tenantDomain, properties);
        } catch (IdentityGovernanceException e) {
            GovernanceConstants.ErrorMessage errorEnum =
