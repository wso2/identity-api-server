...
public class ServerConfigManagementServiceFactory {
    ...
    static {
        if (log.isDebugEnabled()) {
            log.debug("Initializing ServerConfigManagementService dependencies.");
        }
        ...
        if (log.isDebugEnabled()) {
            log.debug("All dependencies successfully loaded. Creating ServerConfigManagementService instance.");
        }
        ...
        if (log.isDebugEnabled()) {
            log.debug("ServerConfigManagementService instance created successfully.");
        }
    }
