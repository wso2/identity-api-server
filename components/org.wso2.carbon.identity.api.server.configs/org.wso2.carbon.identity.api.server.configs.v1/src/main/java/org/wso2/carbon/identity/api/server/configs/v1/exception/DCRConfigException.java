...
/**
 * Base exception class for the DCR Config Management Service.
 */
public class DCRConfigException extends Exception {
     ...
     */
    public DCRConfigException(String message, String errorCode) {
     ...
     */
    public DCRConfigException(String message, String errorCode, Throwable cause) {
     ...
     * @param cause Exception to be wrapped.
     */
    public DCRConfigException(Throwable cause) {
