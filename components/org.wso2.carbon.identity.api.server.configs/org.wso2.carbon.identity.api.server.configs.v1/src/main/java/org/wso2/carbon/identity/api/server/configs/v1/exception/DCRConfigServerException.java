...
public class DCRConfigServerException extends JWTClientAuthenticatorException {
     ...
     */
    public DCRConfigServerException() {
     ...
     */
    public DCRConfigServerException(String message, String errorCode) {
     ...
     */
    public DCRConfigServerException(String message, String errorCode, Throwable cause) {
     ...
     * @param cause Exception to be wrapped.
     */
    public DCRConfigServerException(Throwable cause) {
