...
public class ConfigsApi  {
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Retrieve issuer usage scope configurations.", notes = "Retrieve issuer usage scope configurations. <b>Scope (Permission) required:</b> <br>   `internal_config_view` ", response = UsageScopePayload.class, authorizations = {
        @Authorization(value = "BasicAuth"),
        @Authorization(value = "OAuth2", scopes = {
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Update issuer usage scope configurations.", notes = "Patch issuer usage scope configurations. <b>Scope (Permission) required:</b> <br>   `internal_config_update` ", response = InboundAuthOAuth2Config.class, authorizations = {
        @Authorization(value = "BasicAuth"),
        @Authorization(value = "OAuth2", scopes = {
    ...
    public Response updateIssuerUsageScopeConfig(@ApiParam(value = "" ) @Valid UsageScopePatch usageScopePatch) {
