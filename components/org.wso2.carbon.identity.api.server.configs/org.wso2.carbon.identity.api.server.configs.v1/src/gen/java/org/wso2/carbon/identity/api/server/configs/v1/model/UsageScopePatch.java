...
public enum UsageScopeEnum {
    ...
    /**
    * Scope defining how the issuer can be used
    **/
    public UsageScopePatch usageScope(UsageScopeEnum usageScope) {

        this.usageScope = usageScope;
        return this;
    }
    
    @ApiModelProperty(example = "ALL_EXISTING_AND_FUTURE_ORGS", value = "Scope defining how the issuer can be used")
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UsageScopePatch usageScopePatch = (UsageScopePatch) o;
        return Objects.equals(this.usageScope, usageScopePatch.usageScope);
    }
    ...
    public String toString() {
        ...
        sb.append("class UsageScopePatch {\n");
