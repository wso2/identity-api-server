...
public class PresentationDefinitionsApiServiceImpl extends PresentationDefinitionsApiService {
    ...
    @Override
    public Response getIssuerConfigs(String definitionId, String credentialId) {

        return Response.ok().entity(CORE_SERVICE.getIssuerConfigs(definitionId, credentialId)).build();
    }
    ...
    public Response replaceIssuerConfigs(String definitionId, String credentialId,
        ...
        return Response.ok().entity(
                CORE_SERVICE.replaceIssuerConfigs(definitionId, credentialId,
