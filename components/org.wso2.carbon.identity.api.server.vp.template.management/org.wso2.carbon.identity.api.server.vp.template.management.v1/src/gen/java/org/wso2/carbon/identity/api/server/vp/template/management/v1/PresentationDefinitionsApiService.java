...
public abstract class PresentationDefinitionsApiService {
    ...
    public abstract Response getIssuerConfigs(String definitionId, String credentialId);

    public abstract Response replaceIssuerConfigs(String definitionId, String credentialId,
