 ...
 *
 * <p>Endpoints (secured — see {@code resource-access-control-v2.xml} for the required scopes):
 * <ul>
 *   <li>POST /openid4vp/vc-verifications         — create a new verification request
 *       (requires {@code internal_vc_verification_create})</li>
 *   <li>GET  /openid4vp/vc-verifications/{id}    — retrieve the request state
 *       (requires {@code internal_vc_verification_view})</li>
 * </ul>
 */
