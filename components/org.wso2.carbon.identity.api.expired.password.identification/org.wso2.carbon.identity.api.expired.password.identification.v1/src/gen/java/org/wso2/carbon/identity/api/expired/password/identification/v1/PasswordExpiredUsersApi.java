...
public class PasswordExpiredUsersApi  {
    ...
    public Response getPasswordExpiredUsers(    @Valid@ApiParam(value = "Latest password updated date.")  @QueryParam("expiredAfter") String expiredAfter,     @Valid@ApiParam(value = "Date to exclude the oldest password expired users.")  @QueryParam("excludeBefore") String excludeBefore) {

        return delegate.getPasswordExpiredUsers(expiredAfter,  excludeBefore );
    }
