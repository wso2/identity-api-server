...
/**
 * Service holder class for consent management.
 */
public class ConsentManagementServiceHolder {

    private ConsentManagementServiceHolder() {}

    private static class ConsentManagerHolder {

        static final ConsentManager SERVICE = (ConsentManager) PrivilegedCarbonContext.getThreadLocalCarbonContext()
                .getOSGiService(ConsentManager.class, null);
    }

    public static ConsentManager getConsentManager() {

        return ConsentManagerHolder.SERVICE;
    }
}
