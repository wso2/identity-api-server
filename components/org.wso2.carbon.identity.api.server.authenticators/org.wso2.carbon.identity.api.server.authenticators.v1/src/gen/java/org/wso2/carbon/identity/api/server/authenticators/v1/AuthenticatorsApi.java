...
public class AuthenticatorsApi  {
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Update the AMR value of the system local authenticators ", notes = "Update the AMR value of the system local authenticators ", response = Authenticator.class, authorizations = {
        @Authorization(value = "BasicAuth"),
        @Authorization(value = "OAuth2", scopes = {
