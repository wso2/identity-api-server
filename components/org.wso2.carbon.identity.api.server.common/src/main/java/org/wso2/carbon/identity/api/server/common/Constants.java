...
public class Constants {
    ...
    public enum ErrorMessages {
        ...
        ERROR_CODE_ERROR_RETRIVING_CHALLENGE(CHALLENGE_QUESTION_PREFIX.getPrefix() + "20004",
        ...
        ERROR_CODE_ERROR_ADDING_CHALLENGES(CHALLENGE_QUESTION_PREFIX.getPrefix() + "10005",
                "Unable to add challenge set.",
                "Server Encountered an error while setting answers to the user challenges."),
        ERROR_CODE_ERROR_UPDATING_CHALLENGE_SET(CHALLENGE_QUESTION_PREFIX.getPrefix() + "10006",
                "Unable to update challenge set.",
                "Server Encountered an error while updating the challenge set."),
        ERROR_CODE_ERROR_DELETING_CHALLENGES(CHALLENGE_QUESTION_PREFIX.getPrefix() + "10007",
        ...
        ERROR_CODE_ERROR_ADDING_CHALLENGE_QUESTION_TO_A_SET(CHALLENGE_QUESTION_PREFIX.getPrefix() + "10009",
                "Unable to add a new challenge question.",
                "Server Encountered an error while adding a new question to the set."),
        ERROR_CODE_ERROR_DELETING_CHALLENGE(CHALLENGE_QUESTION_PREFIX.getPrefix() + "10010",
                "Unable to remove challenge question.",
                "Server Encountered an error while removing the challenge question."),
        ERROR_CODE_ERROR_OPERATION_NOT_SUPPORTED(CHALLENGE_QUESTION_PREFIX.getPrefix() + "10010",
        ...
        ERROR_CHALLENGE_SET_NOT_EXISTS(CHALLENGE_QUESTION_PREFIX.getPrefix() + "10012",
