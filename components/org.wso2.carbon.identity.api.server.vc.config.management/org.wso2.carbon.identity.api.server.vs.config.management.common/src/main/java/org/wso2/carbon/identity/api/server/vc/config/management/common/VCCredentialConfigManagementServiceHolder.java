...
public final class VCCredentialConfigManagementServiceHolder {
    ...
    private static class VCCredentialConfigManagerHolder {
        private static final VCCredentialConfigManager SERVICE =
                (VCCredentialConfigManager) PrivilegedCarbonContext.getThreadLocalCarbonContext()
                        .getOSGiService(VCCredentialConfigManager.class, null);
    }
    ...
    public static VCCredentialConfigManager getVCCredentialConfigManager() {
        ...
        return VCCredentialConfigManagerHolder.SERVICE;
