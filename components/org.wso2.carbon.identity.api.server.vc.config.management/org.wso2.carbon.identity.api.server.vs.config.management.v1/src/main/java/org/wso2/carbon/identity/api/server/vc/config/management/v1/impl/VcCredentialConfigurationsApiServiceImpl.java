...
public class VcCredentialConfigurationsApiServiceImpl implements VcCredentialConfigurationsApiService {
    ...
    private final ServerVCCredentialConfigManagementService serverVCCredentialConfigManagementService;

    public VcCredentialConfigurationsApiServiceImpl() {

        try {
            this.serverVCCredentialConfigManagementService =
                    ServerVCCredentialConfigManagementServiceFactory
                            .getServerVCCredentialConfigManagementService();
        } catch (IllegalStateException e) {
            throw new RuntimeException("Error occurred while initiating ServerVCCredentialConfigManagementService.", e);
        }
    }
