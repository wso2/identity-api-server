...
public class VCOfferCreationModel  {
    ...
    /**
    **/
    public VCOfferCreationModel displayName(String displayName) {
    ...
    /**
    **/
    public VCOfferCreationModel credentialConfigurationIds(List<String> credentialConfigurationIds) {
    ...
    public VCOfferCreationModel addCredentialConfigurationIdsItem(String credentialConfigurationIdsItem) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VCOfferCreationModel vcOfferCreationModel = (VCOfferCreationModel) o;
        return Objects.equals(this.displayName, vcOfferCreationModel.displayName) &&
            Objects.equals(this.credentialConfigurationIds, vcOfferCreationModel.credentialConfigurationIds);
    }

    @Override
    public int hashCode() {
        return Objects.hash(displayName, credentialConfigurationIds);
    }
    ...
    public String toString() {
        ...
        sb.append("class VCOfferCreationModel {\n");
