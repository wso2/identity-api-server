...
public class VCOfferUpdateModel  {
    ...
    **/
    ...
    /**
    **/
    public VCOfferUpdateModel credentialConfigurationIds(List<String> credentialConfigurationIds) {
    ...
    public VCOfferUpdateModel addCredentialConfigurationIdsItem(String credentialConfigurationIdsItem) {
        if (this.credentialConfigurationIds == null) {
            this.credentialConfigurationIds = new ArrayList<String>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VCOfferUpdateModel vcOfferUpdateModel = (VCOfferUpdateModel) o;
        return Objects.equals(this.displayName, vcOfferUpdateModel.displayName) &&
            Objects.equals(this.credentialConfigurationIds, vcOfferUpdateModel.credentialConfigurationIds);
    }
    ...
    public String toString() {
        ...
        sb.append("class VCOfferUpdateModel {\n");
