...
public class ServerRemoteFetchConfigManagementServiceFactory {
    ...
    static {
        if (log.isDebugEnabled()) {
            log.debug("Initializing ServerRemoteFetchConfigManagementService factory.");
        }
        ...
        log.info("ServerRemoteFetchConfigManagementService factory initialized successfully.");
    }
