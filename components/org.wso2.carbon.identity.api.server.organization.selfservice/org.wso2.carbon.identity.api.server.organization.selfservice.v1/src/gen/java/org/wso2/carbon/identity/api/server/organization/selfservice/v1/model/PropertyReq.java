...
/**
 * Self service property to patch.
 **/

import java.util.Objects;
import javax.validation.Valid;

@ApiModel(description = "Self service property to patch.")
public class PropertyReq  {
    ...
    **/
    ...
    @ApiModelProperty(example = "auto.login.enable", required = true, value = "Property name.")
    @JsonProperty("name")
    @Valid
